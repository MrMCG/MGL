...
MGLContextManager::MGLContextManager() {}
...
MGLContextManager::MGLContextManager(MGLContextManager && rhs) : m_window(rhs.m_window) {
	rhs.m_window = nullptr;
}

void MGLContextManager::init() {
...
MGLContextManager & MGLContextManager::operator=(MGLContextManager && rhs) {
	cleanup();
...
void MGLContextManager::cleanup() {
	if (m_window != nullptr) {
...
void MGLContextManager::setWindowHints() {
